...
module.exports.run = async function({ api, event, args }) {
    ...
    if(keySearch.includes("-") == false) return api.sendMessage('Please enter in the format, example: pinterest Gojo Satoru - 10 (20 limit only)', event.threadID, event.messageID)
