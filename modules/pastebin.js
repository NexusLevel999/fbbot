...
module.exports.config = {
		...
		access: 3,
		needPrefix: false,
		info: "Upload files to Pastebin and sends link",
		usage: "To use this command, type {prefix}pastebin <filename>. The file must be located in the current directory.",
		alt: ["pistabin","pasteupl"],
};
